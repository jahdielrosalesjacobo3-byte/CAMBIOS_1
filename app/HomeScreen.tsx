...
export default function HomeScreen() {
  ...
  const handleReceive = () => {
    // TODO: Implementar pantalla de recibir
    Alert.alert('Recibir', 'Función de recibir en desarrollo');
  };

  const handleHistory = () => {
    // TODO: Implementar pantalla de historial
    Alert.alert('Historial', 'Función de historial en desarrollo');
  };
      ...
      >
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.balanceAmount}>
            ${balance?.balance.toFixed(2) || '1000.00'}
          </Text>
